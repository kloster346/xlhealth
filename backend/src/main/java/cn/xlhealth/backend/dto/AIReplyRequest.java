package cn.xlhealth.backend.dto;
...
public class AIReplyRequest {
    ...
    public static class ReplyPreferences {
        @Schema(description = "回复类型偏好", example = "EMOTIONAL_SUPPORT", 
                allowableValues = {"EMOTIONAL_SUPPORT", "COGNITIVE_GUIDANCE", "BEHAVIORAL_ADVICE", "INFORMATION_GATHERING"})
        private String preferredType;

        @Schema(description = "回复长度偏好", example = "MEDIUM", 
                allowableValues = {"SHORT", "MEDIUM", "LONG"})
        private String length = "MEDIUM";

        @Schema(description = "回复语调", example = "WARM", 
                allowableValues = {"PROFESSIONAL", "WARM", "CASUAL"})
