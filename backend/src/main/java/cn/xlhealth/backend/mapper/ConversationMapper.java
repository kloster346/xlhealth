...
public interface ConversationMapper extends BaseMapper<Conversation> {
    ...
    int updateStatus(@Param("conversationId") Long conversationId, @Param("status") Conversation.ConversationStatus status);
    ...
    int updateStatistics(@Param("conversationId") Long conversationId, @Param("messageCount") Integer messageCount, @Param("totalTokens") Integer totalTokens);
